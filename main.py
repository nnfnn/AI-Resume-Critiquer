...
st.set_page_config(page_title="AI Resume Critiquer", layout="wide")
...
if analyze and uploaded_file:
    try:
        ...
        2.Skills presenation
        3.Experiance discription. 
        ...
        st.markdown(response.choices[0].message.conent)
